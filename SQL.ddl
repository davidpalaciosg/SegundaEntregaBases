...
ALTER TABLE Ciudad ADD CONSTRAINT FKCiudad766666 FOREIGN KEY (DepartamentoCodigo, DepartamentoPaisCodigo) REFERENCES Departamento (Codigo, PaisCodigo);
ALTER TABLE Departamento ADD CONSTRAINT FKDepartamen363548 FOREIGN KEY (PaisCodigo) REFERENCES Pais (Codigo);
ALTER TABLE Foto ADD CONSTRAINT FKFoto985866 FOREIGN KEY (UbicacionCiudadCodigo, UbicacionDepartamentoCodigo, UbicacionPaisCodigo) REFERENCES Ubicacion (CiudadCodigo, CiudadDepartamentoCodigo, CiudadDepartamentoPaisCodigo);
ALTER TABLE HostedFoto ADD CONSTRAINT FKHostedFoto677201 FOREIGN KEY (FotoID) REFERENCES Foto (ID);
ALTER TABLE FotosPorCompra ADD CONSTRAINT FKFotosPorCo465930 FOREIGN KEY (FotoID) REFERENCES Foto (ID);
ALTER TABLE Foto ADD CONSTRAINT FKFoto686490 FOREIGN KEY (EstadoEliminacionID) REFERENCES EstadoEliminacion (ID);
ALTER TABLE Foto ADD CONSTRAINT FKFoto330126 FOREIGN KEY (TiposdeSujetoID) REFERENCES TiposdeSujeto (ID);
ALTER TABLE Foto ADD CONSTRAINT FKFoto197006 FOREIGN KEY (TiposTemaID) REFERENCES TiposTema (ID);
ALTER TABLE Foto ADD CONSTRAINT FKFoto688382 FOREIGN KEY (ResolucionID) REFERENCES Resolucion (ID);
ALTER TABLE Foto ADD CONSTRAINT FKFoto204527 FOREIGN KEY (TipoTamanoID) REFERENCES TipoTamano (ID);
ALTER TABLE Foto ADD CONSTRAINT FKFoto34442 FOREIGN KEY (FotografoUsuarioNombreUsuario) REFERENCES Fotografo (UsuarioNombreUsuario);
ALTER TABLE HostedFoto ADD CONSTRAINT FKHostedFoto990302 FOREIGN KEY (SitioDescargaURL) REFERENCES SitioDescarga (URL);
ALTER TABLE Fotografo ADD CONSTRAINT FKFotografo191829 FOREIGN KEY (TiposExperienciaID) REFERENCES TiposExperiencia (ID);
ALTER TABLE Fotografo ADD CONSTRAINT FKFotografo173847 FOREIGN KEY (UsuarioNombreUsuario) REFERENCES Usuario (NombreUsuario);
ALTER TABLE Comprador ADD CONSTRAINT FKComprador564136 FOREIGN KEY (NombreUsuario) REFERENCES Usuario (NombreUsuario);
ALTER TABLE FotosPorCompra ADD CONSTRAINT FKFotosPorCo184216 FOREIGN KEY (CompraID, NombreUsuarioComprador) REFERENCES Compra (ID, NombreUsuarioComprador);
ALTER TABLE HistorialVisitas ADD CONSTRAINT FKHistorialV284967 FOREIGN KEY (CompradorNombreUsuario) REFERENCES Comprador (NombreUsuario);
ALTER TABLE Factura ADD CONSTRAINT FKFactura82707 FOREIGN KEY (CompraID, CompraNombreUsuarioComprador) REFERENCES Compra (ID, NombreUsuarioComprador);
ALTER TABLE Compra ADD CONSTRAINT FKCompra267872 FOREIGN KEY (PeriodoFechas) REFERENCES Periodo (Fechas);
ALTER TABLE Tarjeta ADD CONSTRAINT FKTarjeta236766 FOREIGN KEY (TiposDeTarjetaID) REFERENCES TiposDeTarjeta (ID);
ALTER TABLE PagoPorCompra ADD CONSTRAINT FKPagoPorCom198703 FOREIGN KEY (FacturaID, FacturaCompraID2, FacturaCompraNombreUsuarioComprador2) REFERENCES Factura (ID, CompraID, CompraNombreUsuarioComprador);
ALTER TABLE ImpuestosAplicados ADD CONSTRAINT FKImpuestosA776564 FOREIGN KEY (FacturaID, FacturaCompraID, FacturaCompraNombreUsuarioComprador2) REFERENCES Factura (ID, CompraID, CompraNombreUsuarioComprador);
ALTER TABLE DescuentosAplicados ADD CONSTRAINT FKDescuentos859140 FOREIGN KEY (FacturaID, FacturaCompraID2, FacturaCompraNombreUsuarioComprador2) REFERENCES Factura (ID, CompraID, CompraNombreUsuarioComprador);
ALTER TABLE Factura ADD CONSTRAINT FKFactura155168 FOREIGN KEY (Fecha) REFERENCES Periodo (Fechas);
ALTER TABLE PagoPorCompra ADD CONSTRAINT FKPagoPorCom68630 FOREIGN KEY (TipoDePagoID) REFERENCES TipoDePago (ID);
ALTER TABLE ImpuestosAplicados ADD CONSTRAINT FKImpuestosA165447 FOREIGN KEY (ImpuestoID) REFERENCES Impuesto (ID);
ALTER TABLE DescuentosAplicados ADD CONSTRAINT FKDescuentos714922 FOREIGN KEY (DescuentoID) REFERENCES Descuento (ID);
ALTER TABLE HistorialVisitas ADD CONSTRAINT FKHistorialV548850 FOREIGN KEY (PeriodoFechas) REFERENCES Periodo (Fechas);
...
INSERT INTO TiposExperiencia(Experiencia) VALUES ('Profesional');
INSERT INTO TiposExperiencia(Experiencia) VALUES ('Amateur');
INSERT INTO SitioDescarga(Nombre) VALUES ('Nohat');
INSERT INTO SitioDescarga(Nombre) VALUES ('XFrame');
INSERT INTO SitioDescarga(Nombre) VALUES ('Pexels');
INSERT INTO SitioDescarga(Nombre) VALUES ('Envato');
INSERT INTO Usuario(Contrasena, Nombre, Apellido, DireccionCorreo) VALUES ('123456789', 'Sebastian', 'Vergara', 's_vergara@javeriana.edu.co');
INSERT INTO Usuario(Contrasena, Nombre, Apellido, DireccionCorreo) VALUES ('Passwords', 'Daria', 'Shetzcova', 'zpaips.kamikas@getmail.fun');
INSERT INTO Usuario(Contrasena, Nombre, Apellido, DireccionCorreo) VALUES ('Contrasena', 'Berendev', 'Ivanov', 'vhumam@gmailya.com');
INSERT INTO Usuario(Contrasena, Nombre, Apellido, DireccionCorreo) VALUES ('21940129', 'Eberhard', 'Grossgasteiger', 'feuyouyubrihe-2145@yopmail.com');
INSERT INTO Usuario(Contrasena, Nombre, Apellido, DireccionCorreo) VALUES ('dGaq3D4P53zayEX9', 'Juan', 'Vargas', 'cmtjuan@gmail.com');
INSERT INTO Usuario(Contrasena, Nombre, Apellido, DireccionCorreo) VALUES ('zraypQdkc6tWyMKp', 'Teresa', 'Garcia', 'teresagr@hotmail.com');
INSERT INTO Usuario(Contrasena, Nombre, Apellido, DireccionCorreo) VALUES ('pgVYMaZmH6DRQBwb', 'Adria', 'Manzano', 'Adrianali@gmail.com');
INSERT INTO Usuario(Contrasena, Nombre, Apellido, DireccionCorreo) VALUES ('KaEubuEf2qZp6RSY', 'Mark', 'Noguera', 'arnoguera@gmail.com');
INSERT INTO Usuario(Contrasena, Nombre, Apellido, DireccionCorreo) VALUES ('KskA6A2vA5HyPGpL', 'Jesus', 'Estrada', 'Thansin85@teleworm.us');
INSERT INTO Usuario(Contrasena, Nombre, Apellido, DireccionCorreo) VALUES ('9XrF6HGXBBuU2kQB', 'Ruben ', 'Salcedo', 'Maden1934@fleckens.hu');
INSERT INTO Fotografo(VentasPasadas, ComisionTotal, TiposExperienciaID) VALUES (2, 13000, 1);
INSERT INTO Fotografo(VentasPasadas, ComisionTotal, TiposExperienciaID) VALUES (2, 6000, 2);
INSERT INTO Fotografo(VentasPasadas, ComisionTotal, TiposExperienciaID) VALUES (2, 12632, 1);
INSERT INTO Fotografo(VentasPasadas, ComisionTotal, TiposExperienciaID) VALUES (691000, 0, 1);
INSERT INTO Fotografo(VentasPasadas, ComisionTotal, TiposExperienciaID) VALUES (12414, 214512, 1);
INSERT INTO Fotografo(VentasPasadas, ComisionTotal, TiposExperienciaID) VALUES (1353, 135543, 1);
...
INSERT INTO Foto(NombreArchivo, Nombre, Fecha, Descripcion, Precio, UbicacionCiudadCodigo, UbicacionDepartamentoCodigo, UbicacionPaisCodigo, FotografoUsuarioNombreUsuario, ResolucionID, TipoTamanoID, TiposTemaID, TiposdeSujetoID, EstadoEliminacionID) VALUES ('uc?export=download&id=1yL0yE6aBkFtF9o7ulMMk1lB4HQJ3QiMJ', 'Woman Wearing Green Crew-neck T-shirt and Black Denim Bottoms Making Face Behind Don&#39;t Trust Anybody Who Doesn&#39;t Have a Sense of Humor Quote on White Wall', '12/09/2018', 'Imagen de una mujer con camiseta verde en frente de un poster que dice "No confies en aquellos que no tienen sentido del humor"', 0, 20953, 91048, 2, 'DariaShetzcova', 1, 1, 1, 2, 1);
INSERT INTO Foto(NombreArchivo, Nombre, Fecha, Descripcion, Precio, UbicacionCiudadCodigo, UbicacionDepartamentoCodigo, UbicacionPaisCodigo, FotografoUsuarioNombreUsuario, ResolucionID, TipoTamanoID, TiposTemaID, TiposdeSujetoID, EstadoEliminacionID) VALUES ('18094?utm_medium=social&utm_source=nohat&utm_campaign=free_resource', 'A young business woman is showing OK sign and holding a document folder, isolated background ', '16/06/2021', 'Joven empresaria dando un OK con un folder.', 10239, 12412904, 2409124, 3, 'DariaShetzcova', 1, 3, 7, 3, 1);
INSERT INTO Foto(NombreArchivo, Nombre, Fecha, Descripcion, Precio, UbicacionCiudadCodigo, UbicacionDepartamentoCodigo, UbicacionPaisCodigo, FotografoUsuarioNombreUsuario, ResolucionID, TipoTamanoID, TiposTemaID, TiposdeSujetoID, EstadoEliminacionID) VALUES ('two-men-in-military-clothing-with-guns-163490/', 'Two Men in Military Clothing With Guns ', '16/09/2018', 'Dos hombres en ropa militar con armas. ', 121240, 43542, 91048, 2, 'Berendey_Ivanov', 1, 2, 9, 4, 1);
INSERT INTO Foto(NombreArchivo, Nombre, Fecha, Descripcion, Precio, UbicacionCiudadCodigo, UbicacionDepartamentoCodigo, UbicacionPaisCodigo, FotografoUsuarioNombreUsuario, ResolucionID, TipoTamanoID, TiposTemaID, TiposdeSujetoID, EstadoEliminacionID) VALUES ('green-slope-in-forest-on-mist-day-4406626/', 'Green slope in forest on mist day ', '15/05/2020', 'Montaña verde en lluvia.', 64253, 43542, 91048, 2, 'eberhardgross', 2, 4, 3, 5, 1);
...
INSERT INTO HostedFoto(SitioDescargaURL, FotoID) VALUES ('https://www.pexels.com/photo/', 3);
INSERT INTO HostedFoto(SitioDescargaURL, FotoID) VALUES ('https://www.pexels.com/photo/', 5);
INSERT INTO Comprador(MetodosPago) VALUES ('Tarjeta');
INSERT INTO Comprador(MetodosPago) VALUES ('Tarjeta');
INSERT INTO Comprador(MetodosPago) VALUES ('Tarjeta');
INSERT INTO Comprador(MetodosPago) VALUES ('Tarjeta');
INSERT INTO Compra(ID, Miniaturas, NombreUsuarioComprador, PeriodoFechas) VALUES (1, 'woman.jpg', 'OmunIaLS', '11/10/2021');
INSERT INTO Compra(ID, Miniaturas, NombreUsuarioComprador, PeriodoFechas) VALUES (2, 'tarjetamadres.jpg', 'HenaTeRg', '11/10/2021');
INSERT INTO Compra(ID, Miniaturas, NombreUsuarioComprador, PeriodoFechas) VALUES (3, 'hombreenfiguras.jpg', 'fURiCIat', '12/10/2021');
INSERT INTO TiposDeTarjeta(Tipo) VALUES ('Visa');
INSERT INTO TiposDeTarjeta(Tipo) VALUES ('Master Card');
INSERT INTO TiposDeTarjeta(Tipo) VALUES ('American Express');
INSERT INTO TiposDeTarjeta(Tipo) VALUES ('UnionPay');
...
INSERT INTO ImpuestosAplicados(FacturaID, ImpuestoID, FacturaCompraID, FacturaCompraNombreUsuarioComprador2, Impuestos) VALUES (1, 3, 1, 'OmunIaLS', null);
INSERT INTO DescuentosAplicados(Descuentos, FacturaID, DescuentoID, FacturaCompraID2, FacturaCompraNombreUsuarioComprador2) VALUES (null, 2, 2, 2, 'HenaTeRg');
INSERT INTO FotosPorCompra(CompraID, NombreUsuarioComprador, NumeroCompra, FotoID, Cantidad) VALUES (1, 'OmunIaLS', 1, 1, 1);
INSERT INTO FotosPorCompra(CompraID, NombreUsuarioComprador, NumeroCompra, FotoID, Cantidad) VALUES (2, 'HenaTeRg', 2, 6, 4);
INSERT INTO HistorialVisitas(NumerodeRegistro, CompradorNombreUsuario, PeriodoFechas) VALUES (1, 'OmunIaLS', '11/10/2021');
INSERT INTO HistorialVisitas(NumerodeRegistro, CompradorNombreUsuario, PeriodoFechas) VALUES (2, 'HenaTeRg', '12/10/2021');
INSERT INTO HistorialVisitas(NumerodeRegistro, CompradorNombreUsuario, PeriodoFechas) VALUES (3, 'fURiCIat', '12/10/2021');
INSERT INTO HistorialVisitas(NumerodeRegistro, CompradorNombreUsuario, PeriodoFechas) VALUES (4, 'OmunIaLS', '13/10/2021');
