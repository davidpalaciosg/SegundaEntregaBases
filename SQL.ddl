...
INSERT INTO Foto(ID, NombreArchivo, Nombre, Fecha, Descripcion, Precio, UbicacionCiudadCodigo, UbicacionDepartamentoCodigo, UbicacionPaisCodigo, FotografoUsuarioNombreUsuario, ResolucionID, TipoTamanoID, TiposTemaID, TiposdeSujetoID, EstadoEliminacionID) VALUES (4, 'two-men-in-military-clothing-with-guns-163490/', 'Two Men in Military Clothing With Guns ', to_date('16/09/2018','DD/MM/YYYY'), 'Dos hombres en ropa militar con armas. ', 121240, 43542, 91048, 2, 'Berendey_Ivanov', 1, 2, 9, 4, 1);
INSERT INTO Foto(ID, NombreArchivo, Nombre, Fecha, Descripcion, Precio, UbicacionCiudadCodigo, UbicacionDepartamentoCodigo, UbicacionPaisCodigo, FotografoUsuarioNombreUsuario, ResolucionID, TipoTamanoID, TiposTemaID, TiposdeSujetoID, EstadoEliminacionID) VALUES (5, 'green-slope-in-forest-on-mist-day-4406626/', 'Green slope in forest on mist day ', to_date('15/05/2020','DD/MM/YYYY'), 'Montana verde en lluvia.', 64253, 43542, 91048, 2, 'eberhardgross', 2, 4, 3, 5, 1);
